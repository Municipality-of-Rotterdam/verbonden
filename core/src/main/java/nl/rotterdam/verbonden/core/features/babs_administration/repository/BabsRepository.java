package nl.rotterdam.verbonden.core.features.babs_administration.repository;
...
public interface BabsRepository extends JpaRepository<BabsEntity, Long> {
    ...
    @Query("""
            SELECT new nl.rotterdam.verbonden.core.features.babs_administration.domain.ListBabsDto(
