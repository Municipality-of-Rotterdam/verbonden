package nl.rotterdam.verbonden.features.marriage_intake.application;

import nl.rotterdam.verbonden.features.extra_administration.domain.ExtraType;
import nl.rotterdam.verbonden.features.extra_administration.repository.ExtraRepository;
import nl.rotterdam.verbonden.features.marriage_intake.domain.ExtraDto;
import nl.rotterdam.verbonden.features.marriage_intake.domain.SaveExtrasDto;
import nl.rotterdam.verbonden.features.marriage_intake.domain.SidebarExtraItemDto;
import nl.rotterdam.verbonden.persistence.ExtraEntity;
import nl.rotterdam.verbonden.config.PlanningConfig;
import nl.rotterdam.verbonden.features.location_administration.domain.HuwelijksType;
import nl.rotterdam.verbonden.features.location_administration.repository.BeschikbaarheidRepository;
...
import nl.rotterdam.verbonden.features.marriage_intake.domain.DossierAccessOutcome;
...
import nl.rotterdam.verbonden.features.marriage_intake.repository.AfspraakRepository;
import nl.rotterdam.verbonden.features.marriage_intake.repository.DossierRepository;
import nl.rotterdam.verbonden.features.marriage_intake.repository.GetuigenRepository;
import nl.rotterdam.verbonden.features.marriage_type_administration.repository.MarriageTypeLocationRepository;
import nl.rotterdam.verbonden.features.marriage_type_administration.repository.MarriageTypeRepository;
...
import nl.rotterdam.verbonden.persistence.GetuigeEntity;
import nl.rotterdam.verbonden.persistence.HuwelijksDossierEntity;
import nl.rotterdam.verbonden.persistence.HuwelijksDossiersPartnerEntity;
import nl.rotterdam.verbonden.persistence.LocatieBeschikbaarheidEntity;
