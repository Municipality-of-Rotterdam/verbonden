package nl.rotterdam.huwelijk.features.extra_administration.ui;

import nl.rotterdam.huwelijk.administration_common.AdministrationBasePage;
import nl.rotterdam.huwelijk.features.extra_administration.application.ExtraAdministrationService;
...
public class ExtraCreatePage extends AdministrationBasePage {
    ...
    public ExtraCreatePage() {
        FeedbackPanel feedback = new FeedbackPanel("feedback");
        feedback.setOutputMarkupId(true);
        pageBody.add(
                new BookmarkablePageLink<>("terugLink", ExtraAdministrationPage.class),
                feedback,
                new CreateExtraForm("extraForm")
        );
    }

    private class CreateExtraForm extends Form<ExtraFormDto> {

        CreateExtraForm(String id) {
            super(id, Model.of(ExtraFormDto.leeg()));
        }
