...
public interface MarriageIntakeService {
    ...
    void slaPasfotoOp(UUID dossierId, String bsn, byte[] pasfotoData, String contentType);

    void verwijderPasfoto(UUID dossierId, String bsn);

    Optional<PasfotoDto> findPasfoto(UUID dossierId, String bsn);
